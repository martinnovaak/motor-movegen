...
bool make_move(board & chessboard, const chessmove move) {
    ...
    Square ks = chessboard.get_king_square<our_color>();
    std::uint64_t test = chessboard.attackers<our_color>(ks);
    if (test) {
        undo_move<our_color, update>(chessboard);
        return false;
    }
...
void undo_move(board & chessboard) {
    ...
    const chessmove played_move = b_info.played_move;
    ...
    const Piece piece = played_move.get_piece();
    ...
    case CAPTURE:
        set_piece<our_color, false>(chessboard, square_from, piece);
        replace_piece<their_color, our_color, false>(chessboard, square_to, played_move.get_captured_piece(), piece);
        break;
    case EN_PASSANT:
    ...
    case KNIGHT_PROMOTION_CAPTURE:
        set_piece<our_color, false>(chessboard, square_from, Pawn);
        replace_piece<their_color, our_color, false>(chessboard, square_to, played_move.get_captured_piece(), Knight);
    case BISHOP_PROMOTION_CAPTURE:
        set_piece<our_color, false>(chessboard, square_from, Pawn);
        replace_piece<their_color, our_color, false>(chessboard, square_to, played_move.get_captured_piece(), Bishop);
    case ROOK_PROMOTION_CAPTURE:
        set_piece<our_color, false>(chessboard, square_from, Pawn);
        replace_piece<their_color, our_color, false>(chessboard, square_to, played_move.get_captured_piece(), Rook);
    case QUEEN_PROMOTION_CAPTURE:
        set_piece<our_color, false>(chessboard, square_from, Pawn);
        replace_piece<their_color, our_color, false>(chessboard, square_to, played_move.get_captured_piece(), Queen);
        break;
    }
